...
def encrypt_rsa_cli():
    message = input("Enter Message to be encrypted with RSA: ")
    enc_message = encrypt_rsa(key=rsa_pubkey, message=message)
    print(f"Encrypted Message RSA:\n{enc_message}\n")


def encrypt_elgamal_cli():
    message = input("Enter Message to be encrypted with Elgamal: ")
...
def decrypt_rsa_cli():
    message = input("Enter Message to be decrypted with  RSA: ")
...
def decrypt_Elgamal_cli():
    message = input("Enter Message to be decrypted with Elgamal: ")
